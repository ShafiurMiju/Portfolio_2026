    ...
    <footer className="border-t border-rule">
      <div className="max-w-[1180px] mx-auto px-6 sm:px-10 py-14">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            <div className="font-serif text-2xl mb-3">Shafiur Rahman</div>
        ...
        <div className="mt-12 pt-6 border-t border-rule-soft flex flex-wrap gap-4 justify-between items-center">
          <span className="eyebrow">© {new Date().getFullYear()} Shafiur Rahman</span>
          <span className="eyebrow">Built with Next.js</span>
        </div>
      </div>
    </footer>
  )
